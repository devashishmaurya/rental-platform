    ...
    <article className="flex flex-col h-full bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-6 md:p-8 flex flex-col flex-grow">
        ...
        <div className="flex flex-wrap gap-3 mt-auto">
          ...
          <Link
            href={secondaryHref}
            className="inline-flex items-center justify-center border border-gray-300 text-gray-700 hover:border-primary-500 hover:text-primary-600 px-5 py-2.5 rounded-lg font-semibold text-sm transition-colors"
          >
            {secondaryLabel}
          </Link>
        </div>
